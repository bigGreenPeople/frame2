...
<script type="text/javascript">
	function deleteItems(){
		document.itemsForm.action="${pageContext.request.contextPath }/item/deleteitem.action";
...
<body> 
<form name="itemsForm" action="${pageContext.request.contextPath }/item/editItemsAllSubmit.action" method="post">
查询条件：
...
<tr><td><input type="submit" value="批量修改"/></td></tr>
</table>
</form>
</body>
