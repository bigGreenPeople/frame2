				...
				<div class="infos">
					<table class="field">
						<tr>
							...
							<td class="field"><s:fielderror fieldName="name"/></td>
						</tr>
						<tr>
							<td class="field">密　　码：</td>
							<td><input type="password" class="text" name="password" /></td>
							<td class="field"><s:fielderror fieldName="password"/></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="field"><s:fielderror fieldName="telePhone"/></td>
						</tr>
						<tr>
							<td class="field">用户姓名：</td>
							<td><input type="text" class="text" name="username" /> </td>	
							<td class="field"><s:fielderror fieldName="username"/></td>			
						</tr>
					</table>
