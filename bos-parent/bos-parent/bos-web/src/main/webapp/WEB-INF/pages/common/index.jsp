	...
	$(function() {
		...
		$("#btnEp").click(function(){
			...
			if(v){
				...
				{
					//发送ajax的请求
					$.post("user_editPassword.action",{"password":v1},function(data){
						if(data == "1"){
							//修改成功关闭窗口
							$("#editPwdWindow").window("close");
						}else{
        ...
        <div class="easyui-layout" fit="true">
            ...
            <form id="editPasswordForm">
                <table cellpadding=3>
                    <tr>
                        <td>新密码：</td>
                        <td><input data-options="validType:'length[4,12]'" required="required" id="txtNewPass" type="Password" class="txt01 easyui-validatebox" /></td>
                    </tr>
                    <tr>
                        <td>确认密码：</td>
                        <td><input data-options="validType:'length[4,12]'" required="required" id="txtRePass" type="Password" class="txt01 easyui-validatebox" /></td>
                    </tr>
                </table>
                </form>
            </div>
