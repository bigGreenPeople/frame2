...
<script type="text/javascript">
	...
	function doAssociations(){
		...
		if(rows.length != 1)
		{
			...
			//发送ajax请求
			var url1 = "decidedzone_findListNotAssociation.action";
			...
			var url2 = "decidedzone_findListHasAssociation.action";
			//得到定区的id 
	...
	$(function(){
		...
		$('#grid').datagrid( {
			...
			pagination : true,
			toolbar : toolbar,
			url : "decidedzone_pageQuery.action",
			idField : 'id',
			columns : columns,
	...
	function doDblClickRow(index,data){
		$('#association_subarea').datagrid( {
			...
			rownumbers : true,
			striped : true,
			url : "subarea_findListByDecidedzoneId.action?decidedzoneId="+data.id,
			columns : [ [{
				field : 'id',
				title : '分区编号',
				width : 120,
		...
		$('#association_customer').datagrid( {
			...
			rownumbers : true,
			striped : true,
			url : "decidedzone_findListHasAssociation.action?id="+data.id,
			columns : [[{
				field : 'id',
				title : '客户编号',
				width : 120,
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="定区添加修改" id="addDecidedzoneWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="addDecidedzoneFrom" method="post" action="decidedzone_add.action">
					...
					<tr>
						...
						<td>
							<input class="easyui-combobox" name="staff.id"  
    							data-options="valueField:'id',textField:'name',url:'staff_listajax.action'" />  
						</td>
					</tr>
					<tr height="300">
						...
						<td>
							...
							data-options="url:'subarea_listajax.action',fitColumns:true,singleSelect:false">
								<thead>  
							        <tr>  
