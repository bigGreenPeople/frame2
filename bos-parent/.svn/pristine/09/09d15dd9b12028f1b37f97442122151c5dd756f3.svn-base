...
//定义一个工具方法，用于将指定的form表单中所有的输入项转为json数据{key:value,key:value}
	...
	$(function(){
		...
		$("#btn").click(function(){
			...
			//使用表格的load方法重新发送一个请求 响应后数据将显示到表格上	但是条件窗口不刷新  这样就能够保留我们的查询条件（为下次翻页提供条件）
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="分区添加修改" id="addSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form action="subarea_add" method="post" id="addSubareaForm">
					...
					<tr>
						...
						<td>
							<input class="easyui-combobox" name="region.id"  
    							data-options="valueField:'id',textField:'name',mode:'remote',url:'region_listajax.action'" />  
						</td>
					</tr>
					<tr>
						<td>关键字</td>
